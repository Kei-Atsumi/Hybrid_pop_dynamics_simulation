...
for(rseed in 1:100) {
  ...
  set.seed(rseed+100) # To make randomization repeatable
  Pheno[2,2] <- paste0(sample(gf_ni$name, 50), collapse = "+")
  set.seed(rseed+200) # Random genes, while differentiating with above
  Pheno[3,2] <- paste0(sample(gf_ni$name, 50), collapse = "+")
  set.seed(rseed+300) # Random genes, while differentiating with above
