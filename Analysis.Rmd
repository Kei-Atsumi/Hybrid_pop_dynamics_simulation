...
#' Title: visualise
#' Visualise simulation result. Need inherit_table
#' @param gset: Genome setting
#' @param sexsel: Sexual selection style
visualise <- function(gset = "", sexsel = "") {  
  ...
  summary <- data %>% 
    ...
    summarise(
      ...
      Polymor_rate = sum(is.na(Genotype) && Gen_ext == 100)/101*100 #Pops kept 2genotypes at 100gen
    ) %>% 
    mutate(across(where(is.numeric), round, 0))
  
  ggplot(data %>% drop_na_("Gen_fix"), aes_string(x = "s", y = "Gen_fix")) +
...
ext_stat(gset = "dis_unlink", sexsel = "recessive")
ext_stat(gset = "dis_unlink", sexsel = "selfref")
# ext_stat(gset = "dis_unlink", sexsel = "speriorhyb")
