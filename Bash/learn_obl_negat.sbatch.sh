...
while [ $COUNTERA -lt $REPS ]; do
 ...
 Y=`echo "$Y + 0.0001" | bc`
 echo $Y
 sed -i -e "s/$X/$Y/g" /lustre/k.atsumi/Config/learn_obl_negat_natsel0.1.cfg
 sed -i -e "s/$X/$Y/g" /lustre/k.atsumi/Config/learn_obl_negat_natsel0.3.cfg
 sed -i -e "s/$X/$Y/g" /lustre/k.atsumi/Config/learn_obl_negat_natsel0.7.cfg
