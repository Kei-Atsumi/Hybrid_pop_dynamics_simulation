...
while [ $COUNTERA -lt $REPS ]; do
 ...
 sed -i -e "s/$X/$Y/g" /lustre/k.atsumi/Config/dis_link_pdominance_natsel0.4.cfg
 ...
 sed -i -e "s/rep${COUNTERA}dir/rep${COUNTERB}dir/g" /lustre/k.atsumi/Config/dis_link_pdominance_natsel0.4.cfg
 ...
 /lustre/k.atsumi/admixem/bin/admixemp /lustre/k.atsumi/Config/dis_link_pdominance_natsel0.4.cfg
