...
find /lustre/k.atsumi/Result/quant_constchoosy* -name "Gen*_markers.txt" -or -name "Gen*_genes.txt" -or -name "Gen*_natselprobdump.txt" -or -type f -empty -delete #Erase unuse files 
